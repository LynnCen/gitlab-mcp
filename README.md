...
```text
查看项目为xxxx，mrid为10821的mr信息以及所有变更内容，按照mr生成规划生成文档，随后将该文档帮我更新到对应的mrid的描述下
```

**生成技术方案**

```text
查看项目为xxxx，mrid为10821的mr信息以及所有变更内容，按照mr生成技术方案，使用markdown格式输出。
```

**AI代码审查完整工作流：**

```text
请分析项目 xxxx 中 MR #11401 的所有变更，并按照项目代码规范进行全面的代码审查，生成行内评论，并生成代码审查报告，并推送到GitLab MR中
```
