...
### 2.8 `update_merge_request_description` ✅ 通过
...
```json
{
  ...
  "merge_request": {
    ...
    "iid": 11533,
    "title": "fix: 落地页报错",
    "description": "...(更新后的描述，551 字符)...",
    "state": "merged",
    "updated_at": "2026-01-29T02:08:28.805Z",
    "description_length": 551
  }
}
```

**测试结论**: ✅ 功能正常，即使 MR 已合并仍可更新描述
...
| `update_merge_request_description` | ✅ 通过 | 更新 MR 描述成功 |
